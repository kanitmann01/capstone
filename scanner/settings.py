...
class ScannerSettings:
    ...
    def from_env() -> "ScannerSettings":
        ...
        Delegates to unified AppConfig for consistency.
        """
        try:
            from pipeline.shared.config import AppConfig, app_config_to_legacy
            app_config = AppConfig.from_env()
            _, scanner_settings = app_config_to_legacy(app_config)
