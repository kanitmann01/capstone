...
class ScannerSettings:
    ...
    weights_heuristics: float = 0.20
    weights_content: float = 0.30
    weights_ssl: float = 0.15
    weights_domain_age: float = 0.15
    weights_threat_intel: float = 0.20
    weights_ml: float = 0.0
    ...
    def from_env() -> "ScannerSettings":
        return ScannerSettings(
            ...
            weights_heuristics=_float_env("WEIGHT_HEURISTICS", 0.20),
            weights_content=_float_env("WEIGHT_CONTENT", 0.30),
            weights_ssl=_float_env("WEIGHT_SSL", 0.15),
            weights_domain_age=_float_env("WEIGHT_DOMAIN_AGE", 0.15),
            weights_threat_intel=_float_env("WEIGHT_THREAT_INTEL", 0.20),
            weights_ml=_float_env("WEIGHT_ML", 0.0),
